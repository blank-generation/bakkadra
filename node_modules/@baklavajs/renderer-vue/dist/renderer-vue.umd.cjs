(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue"), require("@baklavajs/core"), require("@baklavajs/events")) : typeof define === "function" && define.amd ? define(["exports", "vue", "@baklavajs/core", "@baklavajs/events"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.BaklavaJSRendererVue = {}, global.Vue, global.core, global.events));
})(this, function(exports2, vue, core, events) {
  "use strict";
  ...
  function useGraph() {
    ...
    return {
      graph: vue.toRef(viewModel.value, "displayedGraph"),
      switchGraph: viewModel.value.switchGraph
    };
  }
  function useDragMove(positionRef) {
    const { graph } = useGraph();
    const draggingStartPoint = vue.ref(null);
    const draggingStartPosition = vue.ref(null);
    const dragging = vue.computed(() => !!draggingStartPoint.value);
  ...
  function checkRecursion(editor, currentGraph, graphNodeType) {
    ...
    if (core.getGraphNodeTypeString(currentGraph.template) === graphNodeType) {
      return true;
    }
    const template = editor.graphTemplates.find((t) => core.getGraphNodeTypeString(t) === graphNodeType);
    if (!template) {
      return false;
    }
    const containedGraphNodes = template.nodes.filter((n) => n.type.startsWith(core.GRAPH_NODE_TYPE_PREFIX));
    ...
    return vue.computed(() => {
      ...
      for (const c of categoryNames.values()) {
        ...
        if (viewModel.value.displayedGraph.template) {
          ...
          nodeTypesInCategory = nodeTypesInCategory.filter(
            ([nt]) => ![core.GRAPH_INPUT_NODE_TYPE, core.GRAPH_OUTPUT_NODE_TYPE].includes(nt)
          );
        }
  ...
  function usePanZoom() {
    ...
    const panningRef = vue.computed(() => graph.value.panning);
  ...
  function provideTemporaryConnection() {
    const { graph } = useGraph();
    const temporaryConnection = vue.ref(null);
    const hoveringOver = vue.ref(null);
    ...
    vue.provide(TEMPORARY_CONNECTION_HANDLER_INJECTION_SYMBOL, {
      temporaryConnection,
      hoveredOver
    });
  ...
  function useTemporaryConnection() {
    const temporaryConnection = vue.inject(TEMPORARY_CONNECTION_HANDLER_INJECTION_SYMBOL);
  ...
  const START_SELECTION_BOX_COMMAND = "START_SELECTION_BOX";
  function useSelectionBox(editorEl) {
    const { viewModel } = useViewModel();
    const { graph } = useGraph();
    const nodes = vue.computed(() => graph.value.nodes);
    const startSelection = vue.ref(false);
    const isSelecting = vue.ref(false);
    const start = vue.ref([0, 0]);
    const end = vue.ref([0, 0]);
    vue.watch(
      viewModel,
      () => {
  ...
  const Background = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["render", _sfc_render$p]]);
  ...
  const _hoisted_1$s = ["onMouseenter", "onMouseleave", "onClick"];
  const _hoisted_2$9 = { class: "flex-fill" };
  const _hoisted_3$7 = {
    key: 0,
  ...
  const _sfc_main$x = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: __emit }) {
      ...
      const rootIsFlipped = vue.ref({ x: false, y: false });
      const flippedX = vue.computed(() => props.flippable && (rootIsFlipped.value.x || props.isFlipped.x));
      const flippedY = vue.computed(() => props.flippable && (rootIsFlipped.value.y || props.isFlipped.y));
      const styles = vue.computed(() => {
        const s = {};
        if (!props.isNested) {
      ...
      const itemsWithHoverProperty = vue.computed(() => props.items.map((i) => ({ ...i, hover: false })));
      vue.watch([() => props.y, () => props.items], () => {
        var _a, _b, _c, _d;
      ...
      return (_ctx, _cache) => {
        const _component_ContextMenu = vue.resolveComponent("ContextMenu", true);
        return vue.openBlock(), vue.createBlock(vue.Transition, { name: "slide-fade" }, {
          default: vue.withCtx(() => [
            vue.withDirectives(vue.createElementVNode("div", {
              ref_key: "el",
              ref: el,
              class: vue.normalizeClass(["baklava-context-menu", classes.value]),
              style: vue.normalizeStyle(styles.value)
            }, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(itemsWithHoverProperty.value, (item, index) => {
                return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
                  item.isDivider ? (vue.openBlock(), vue.createElementBlock("div", {
                    key: `d-${index}`,
                    class: "divider"
                  })) : (vue.openBlock(), vue.createElementBlock("div", {
                    key: `i-${index}`,
                    class: vue.normalizeClass(["item", { "submenu": !!item.submenu, "--disabled": !!item.disabled }]),
                    onMouseenter: ($event) => onMouseEnter($event, index),
                    onMouseleave: ($event) => onMouseLeave($event, index),
                    onClick: vue.withModifiers(($event) => onClick(item), ["stop", "prevent"])
                  }, [
                    vue.createElementVNode("div", _hoisted_2$9, vue.toDisplayString(item.label), 1),
                    item.submenu ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$7, _cache[0] || (_cache[0] = [
                    ...
                    item.submenu ? (vue.openBlock(), vue.createBlock(_component_ContextMenu, {
                      key: 1,
                    ...
                    }, null, 8, ["model-value", "items", "is-flipped", "flippable"])) : vue.createCommentVNode("", true)
                  ], 42, _hoisted_1$s))
                ], 64);
              }), 256))
            ], 6), [
  ...
  const VerticalDots = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$o]]);
  ...
  const _sfc_main$v = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const showTooltip = vue.computed(() => viewModel.value.settings.displayValueOnHover && isHovered.value);
      const classes = vue.computed(() => ({
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          _ctx.intf.port ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: vue.normalizeClass(["__port", { "--selected": ((_a = vue.unref(temporaryConnection)) == null ? void 0 : _a.from) === _ctx.intf }]),
            onPointerover: startHover,
            onPointerout: endHover
          }, [
            vue.renderSlot(_ctx.$slots, "portTooltip", { showTooltip: showTooltip.value }, () => [
              showTooltip.value === true ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$8, vue.toDisplayString(ellipsis(_ctx.intf.value)), 1)) : vue.createCommentVNode("", true)
            ])
          ], 34)) : vue.createCommentVNode("", true),
          showComponent.value ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.intf.component), {
            key: 1,
          ...
          }, null, 40, ["modelValue", "node", "intf"])) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$6, vue.toDisplayString(_ctx.intf.name), 1))
        ], 10, _hoisted_1$q);
      };
    }
  });
  const _hoisted_1$p = ["id", "data-node-type"];
  const _hoisted_2$7 = { class: "__title-label" };
  const _hoisted_3$5 = { class: "__menu" };
  const _hoisted_4$5 = { class: "__outputs" };
  const _hoisted_5$1 = { class: "__inputs" };
  const _sfc_main$u = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: __emit }) {
      ...
      const contextMenuItems = vue.computed(() => {
        ...
        if (props.node.type.startsWith(core.GRAPH_NODE_TYPE_PREFIX)) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          ref_key: "el",
          ref: el,
          class: vue.normalizeClass(["baklava-node", classes.value]),
          style: vue.normalizeStyle(styles.value),
          ...
          vue.renderSlot(_ctx.$slots, "title", {}, () => [
            vue.createElementVNode("div", {
              ...
              !renaming.value ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                vue.createElementVNode("div", _hoisted_2$7, vue.toDisplayString(_ctx.node.title), 1),
                vue.createElementVNode("div", _hoisted_3$5, [
                  vue.createVNode(VerticalDots, {
                    class: "--clickable",
            ...
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("div", _hoisted_4$5, [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(displayedOutputs.value, (output) => {
                  return vue.renderSlot(_ctx.$slots, "nodeInterface", {
                    key: output.id,
                    type: "output",
                    node: _ctx.node,
                    intf: output
  ...
  const _hoisted_1$o = ["d"];
  function _sfc_render$n(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("path", {
      class: vue.normalizeClass(["baklava-connection", _ctx.classes]),
      d: _ctx.d
    }, null, 10, _hoisted_1$o);
  }
  const ConnectionView = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render$n]]);
  ...
  const _sfc_main$s = vue.defineComponent({
    ...
    setup(props) {
      ...
      vue.watch([fromNodePosition, toNodePosition], () => updateCoords(), { deep: true });
      return { d, state };
    }
  });
  function _sfc_render$m(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_connection_view = vue.resolveComponent("connection-view");
    return vue.openBlock(), vue.createBlock(_component_connection_view, {
      x1: _ctx.d.x1,
      y1: _ctx.d.y1,
      x2: _ctx.d.x2,
      y2: _ctx.d.y2,
  ...
  const ConnectionWrapper = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$m]]);
  ...
  const _sfc_main$r = vue.defineComponent({
    ...
    setup(props) {
      const status = vue.computed(() => props.connection ? props.connection.status : TemporaryConnectionState.NONE);
      const d = vue.computed(() => {
        if (!props.connection) {
          return {
            input: [0, 0],
  ...
  const TemporaryConnection = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$l]]);
  ...
  const _hoisted_1$n = { class: "__header" };
  const _hoisted_2$6 = { class: "__node-name" };
  function _sfc_render$k(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      ref: "el",
      class: vue.normalizeClass(["baklava-sidebar", { "--open": _ctx.graph.sidebar.visible }]),
      style: vue.normalizeStyle(_ctx.styles)
    }, [
      ...
      vue.createElementVNode("div", _hoisted_1$n, [
        ...
        vue.createElementVNode("div", _hoisted_2$6, [
          vue.createElementVNode("b", null, vue.toDisplayString(_ctx.node ? _ctx.node.title : ""), 1)
        ])
      ]),
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.displayedInterfaces, (intf) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          key: intf.id,
          class: "__interface"
        }, [
  ...
  const Sidebar = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$k]]);
  const _sfc_main$p = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const showViewBounds = vue.ref(false);
      let ctx;
      let dragging = false;
      ...
      vue.watch([showViewBounds, graph.value.panning, () => graph.value.scaling, () => graph.value.connections.length], () => {
        updateCanvas();
      });
      const nodePositions = vue.computed(() => graph.value.nodes.map((n) => n.position));
      const nodeSizes = vue.computed(() => graph.value.nodes.map((n) => n.width));
      vue.watch(
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("canvas", {
          ...
          onMousedown: vue.withModifiers(mousedown, ["self"]),
          onMousemove: vue.withModifiers(mousemove, ["self"]),
          onMouseup: mouseup,
  ...
  const _sfc_main$o = vue.defineComponent({
    ...
    setup(props) {
      ...
      const showContextMenu = vue.ref(false);
      const hasContextMenu = vue.computed(() => props.type.startsWith(core.GRAPH_NODE_TYPE_PREFIX));
      ...
      const onContextMenuClick = (action) => {
        const graphTemplateId = props.type.substring(core.GRAPH_NODE_TYPE_PREFIX.length);
  ...
  const _hoisted_1$m = ["data-node-type"];
  const _hoisted_2$5 = { class: "__title" };
  const _hoisted_3$4 = { class: "__title-label" };
  const _hoisted_4$4 = {
    key: 0,
    class: "__menu"
  };
  function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_vertical_dots = vue.resolveComponent("vertical-dots");
    const _component_context_menu = vue.resolveComponent("context-menu");
    return vue.openBlock(), vue.createElementBlock("div", {
      class: "baklava-node --palette",
      "data-node-type": _ctx.type
    }, [
      vue.createElementVNode("div", _hoisted_2$5, [
        vue.createElementVNode("div", _hoisted_3$4, vue.toDisplayString(_ctx.title), 1),
        _ctx.hasContextMenu ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$4, [
          vue.createVNode(_component_vertical_dots, {
            class: "--clickable",
            onPointerdown: _cache[0] || (_cache[0] = vue.withModifiers(() => {
            }, ["stop", "prevent"])),
            onClick: vue.withModifiers(_ctx.openContextMenu, ["stop", "prevent"])
          }, null, 8, ["onClick"]),
          vue.createVNode(_component_context_menu, {
  ...
  const PaletteEntry = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$j]]);
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createElementVNode("div", {
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(categories), (c) => {
              return vue.openBlock(), vue.createElementBlock("section", {
                key: c.name
              }, [
                c.name !== "default" ? (vue.openBlock(), vue.createElementBlock("h1", _hoisted_1$l, vue.toDisplayString(c.name), 1)) : vue.createCommentVNode("", true),
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(c.nodeTypes, (ni, nt) => {
  ...
  const _hoisted_1$k = ["disabled", "title"];
  function _sfc_render$i(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("button", {
      ...
      _ctx.icon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.icon), { key: 0 })) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
        vue.createTextVNode(vue.toDisplayString(_ctx.title), 1)
      ], 64))
    ], 8, _hoisted_1$k);
  }
  const ToolbarButton = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$i]]);
  const _sfc_main$l = /* @__PURE__ */ vue.defineComponent({
    __name: "Toolbar",
    setup(__props) {
      const { viewModel } = useViewModel();
      const isSubgraph = vue.computed(() => viewModel.value.displayedGraph !== viewModel.value.editor.graph);
      const commands = vue.computed(() => viewModel.value.settings.toolbar.commands);
      const subgraphCommands = vue.computed(() => viewModel.value.settings.toolbar.subgraphCommands);
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(commands.value, (c) => {
            return vue.openBlock(), vue.createBlock(ToolbarButton, {
              key: c.command,
              command: c.command,
              title: c.title,
              icon: c.icon
          ...
          isSubgraph.value ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 0 }, vue.renderList(subgraphCommands.value, (c) => {
            return vue.openBlock(), vue.createBlock(ToolbarButton, {
              key: c.command,
              command: c.command,
              title: c.title,
  ...
  const _hoisted_1$j = { class: "connections-container" };
  const _sfc_main$k = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      const viewModelRef2 = vue.toRef(props, "viewModel");
      providePlugin(viewModelRef2);
      const el = vue.ref(null);
      vue.provide("editorEl", el);
      const nodes = vue.computed(() => props.viewModel.displayedGraph.nodes);
      const dragMoves = vue.computed(() => props.viewModel.displayedGraph.nodes.map((n) => useDragMove(vue.toRef(n, "position"))));
      const connections = vue.computed(() => props.viewModel.displayedGraph.connections);
      const selectedNodes = vue.computed(() => props.viewModel.displayedGraph.selectedNodes);
      ...
      const nodeContainerStyle = vue.computed(() => ({
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          ...
          ref: el,
          tabindex: "-1",
          class: vue.normalizeClass(["baklava-editor", {
            "baklava-ignore-mouse": !!vue.unref(temporaryConnection).temporaryConnection.value || vue.unref(panZoom).dragging.value,
            "--temporary-connection": !!vue.unref(temporaryConnection).temporaryConnection.value,
            "--start-selection-box": vue.unref(selectionBox).startSelection
          }]),
          onPointermove: vue.withModifiers(onPointerMove, ["self"]),
          onPointerdown: onPointerDown,
          onPointerup: onPointerUp,
          onWheel: _cache[1] || (_cache[1] = vue.withModifiers(
            //@ts-ignore
            (...args) => vue.unref(panZoom).onMouseWheel && vue.unref(panZoom).onMouseWheel(...args),
            ["self"]
          )),
          onKeydown: keyDown,
          onKeyup: keyUp,
          onContextmenu: _cache[2] || (_cache[2] = vue.withModifiers(
            //@ts-ignore
            (...args) => vue.unref(contextMenu).open && vue.unref(contextMenu).open(...args),
            ["self"]
          ))
        }, [
          vue.renderSlot(_ctx.$slots, "background", {}, () => [
            vue.createVNode(Background)
          ]),
          vue.renderSlot(_ctx.$slots, "toolbar", {}, () => [
            _ctx.viewModel.settings.toolbar.enabled ? (vue.openBlock(), vue.createBlock(_sfc_main$l, { key: 0 })) : vue.createCommentVNode("", true)
          ]),
          vue.renderSlot(_ctx.$slots, "palette", {}, () => [
            _ctx.viewModel.settings.palette.enabled ? (vue.openBlock(), vue.createBlock(_sfc_main$n, { key: 0 })) : vue.createCommentVNode("", true)
          ]),
          (vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$j, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(connections.value, (connection) => {
              return vue.openBlock(), vue.createElementBlock("g", {
                key: connection.id + counter.value.toString()
              }, [
                vue.renderSlot(_ctx.$slots, "connection", { connection }, () => [
                  vue.createVNode(ConnectionWrapper, { connection }, null, 8, ["connection"])
                ])
              ]);
            }), 128)),
            vue.renderSlot(_ctx.$slots, "temporaryConnection", {
              temporaryConnection: vue.unref(temporaryConnection).temporaryConnection.value
            }, () => [
              vue.unref(temporaryConnection).temporaryConnection.value ? (vue.openBlock(), vue.createBlock(TemporaryConnection, {
                key: 0,
                connection: vue.unref(temporaryConnection).temporaryConnection.value
              }, null, 8, ["connection"])) : vue.createCommentVNode("", true)
            ])
          ])),
          vue.createElementVNode("div", {
            class: "node-container",
            style: vue.normalizeStyle(nodeContainerStyle.value)
          }, [
            vue.createVNode(vue.TransitionGroup, { name: "fade" }, {
              default: vue.withCtx(() => [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(nodes.value, (node, idx) => {
                  return vue.renderSlot(_ctx.$slots, "node", {
          ...
          vue.renderSlot(_ctx.$slots, "sidebar", {}, () => [
            _ctx.viewModel.settings.sidebar.enabled ? (vue.openBlock(), vue.createBlock(Sidebar, { key: 0 })) : vue.createCommentVNode("", true)
          ]),
          vue.renderSlot(_ctx.$slots, "minimap", {}, () => [
            _ctx.viewModel.settings.enableMinimap ? (vue.openBlock(), vue.createBlock(_sfc_main$p, { key: 0 })) : vue.createCommentVNode("", true)
          ]),
          vue.renderSlot(_ctx.$slots, "contextMenu", { contextMenu: vue.unref(contextMenu) }, () => [
            _ctx.viewModel.settings.contextMenu.enabled ? (vue.openBlock(), vue.createBlock(_sfc_main$x, {
              key: 0,
              modelValue: vue.unref(contextMenu).show.value,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => vue.unref(contextMenu).show.value = $event),
              items: vue.unref(contextMenu).items.value,
              x: vue.unref(contextMenu).x.value,
              y: vue.unref(contextMenu).y.value,
              onClick: vue.unref(contextMenu).onClick
            }, null, 8, ["modelValue", "items", "x", "y", "onClick"])) : vue.createCommentVNode("", true)
          ]),
          vue.unref(selectionBox).isSelecting ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: "selection-box",
            style: vue.normalizeStyle(vue.unref(selectionBox).getStyles())
  ...
  function useHotkeyHandler(executeCommand) {
    const pressedKeys = vue.ref([]);
    const handlers = vue.ref([]);
  ...
  const useCommandHandler = () => {
    const commands = vue.ref(/* @__PURE__ */ new Map());
    ...
    return vue.reactive({ hasCommand, registerCommand, executeCommand, canExecuteCommand, ...hotkeyHandler });
  };
  ...
  function _sfc_render$h(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, vue.toDisplayString(_ctx.intf.name), 9, _hoisted_1$i);
  }
  const ButtonInterfaceComponent = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$h]]);
  class ButtonInterface extends core.NodeInterface {
    constructor(name, callback) {
      super(name, void 0);
      this.component = vue.markRaw(ButtonInterfaceComponent);
      this.callback = callback;
      this.setPort(false);
    }
  }
  const _hoisted_1$h = ["title"];
  const _hoisted_2$4 = { class: "__label" };
  const _sfc_main$i = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: __emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          class: vue.normalizeClass(["baklava-checkbox", { "--checked": _ctx.modelValue }]),
          title: _ctx.intf.name,
          ...
          vue.createElementVNode("div", _hoisted_2$4, vue.toDisplayString(_ctx.intf.name), 1)
        ], 10, _hoisted_1$h);
      };
    }
  });
  class CheckboxInterface extends core.NodeInterface {
    constructor() {
      super(...arguments);
      this.component = vue.markRaw(_sfc_main$i);
    }
  }
  ...
  class BaseNumericInterface extends core.NodeInterface {
  ...
  const useBaseNumericInterface = (intf, precision = 3) => {
    ...
    const stringRepresentation = vue.computed(() => {
  ...
  const Arrow = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$g]]);
  const _sfc_main$g = vue.defineComponent({
    ...
    setup(props) {
      const baseNumericInterface = useBaseNumericInterface(vue.toRef(props, "intf"), 0);
      const increment = () => {
  ...
  const _hoisted_3$3 = { class: "__value" };
  const _hoisted_4$3 = {
    key: 1,
    class: "__content"
  };
  function _sfc_render$f(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_i_arrow = vue.resolveComponent("i-arrow");
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$f, [
      vue.createElementVNode("div", {
        class: "__button --dec",
        onClick: _cache[0] || (_cache[0] = (...args) => _ctx.decrement && _ctx.decrement(...args))
      }, [
        vue.createVNode(_component_i_arrow)
      ]),
      !_ctx.editMode ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        class: "__content",
        ...
        vue.createElementVNode("div", {
          class: "__label",
          title: _ctx.intf.name
        }, vue.toDisplayString(_ctx.intf.name), 9, _hoisted_2$3),
        vue.createElementVNode("div", _hoisted_3$3, vue.toDisplayString(_ctx.stringRepresentation), 1)
        ...
        vue.withDirectives(vue.createElementVNode("input", {
          ...
          type: "number",
          class: vue.normalizeClass(["baklava-input", { "--invalid": _ctx.invalid }]),
          style: { "text-align": "right" },
          onBlur: _cache[3] || (_cache[3] = (...args) => _ctx.leaveEditMode && _ctx.leaveEditMode(...args)),
          onKeydown: _cache[4] || (_cache[4] = vue.withKeys((...args) => _ctx.leaveEditMode && _ctx.leaveEditMode(...args), ["enter"]))
        }, null, 34), [
          [vue.vModelText, _ctx.tempValue]
        ])
      ])),
      vue.createElementVNode("div", {
        class: "__button --inc",
  ...
  const IntegerInterfaceComponent = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f]]);
  class IntegerInterface extends BaseNumericInterface {
    constructor() {
      super(...arguments);
      this.component = vue.markRaw(IntegerInterfaceComponent);
    }
    validate(v) {
  ...
  const _hoisted_3$2 = { class: "__value" };
  const _hoisted_4$2 = {
    key: 1,
    class: "__content"
  };
  const _sfc_main$f = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      const props = __props;
      const { editMode, invalid, tempValue, inputEl, stringRepresentation, enterEditMode, leaveEditMode, setValue } = useBaseNumericInterface(vue.toRef(props, "intf"));
      function increment() {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$e, [
          vue.createElementVNode("div", {
            ...
            vue.createVNode(Arrow)
          ]),
          !vue.unref(editMode) ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            class: "__content",
            onClick: _cache[0] || (_cache[0] = //@ts-ignore
            (...args) => vue.unref(enterEditMode) && vue.unref(enterEditMode)(...args))
          }, [
            vue.createElementVNode("div", {
              class: "__label",
              title: _ctx.intf.name
            }, vue.toDisplayString(_ctx.intf.name), 9, _hoisted_2$2),
            vue.createElementVNode("div", _hoisted_3$2, vue.toDisplayString(vue.unref(stringRepresentation)), 1)
          ])) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$2, [
            vue.withDirectives(vue.createElementVNode("input", {
              ref_key: "inputEl",
              ref: inputEl,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => vue.isRef(tempValue) ? tempValue.value = $event : null),
              type: "number",
              class: vue.normalizeClass(["baklava-input", { "--invalid": vue.unref(invalid) }]),
              style: { "text-align": "right" },
              onBlur: _cache[2] || (_cache[2] = //@ts-ignore
              (...args) => vue.unref(leaveEditMode) && vue.unref(leaveEditMode)(...args)),
              ...
              [vue.vModelText, vue.unref(tempValue)]
            ])
          ])),
          vue.createElementVNode("div", {
            class: "__button --inc",
  ...
  class NumberInterface extends BaseNumericInterface {
    constructor() {
      super(...arguments);
      this.component = vue.markRaw(_sfc_main$f);
    }
  }
  ...
  const _hoisted_2$1 = { class: "__selected" };
  const _hoisted_3$1 = { class: "__text" };
  const _hoisted_4$1 = { class: "__icon" };
  ...
  function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", {
      ref: "el",
      class: vue.normalizeClass(["baklava-select", { "--open": _ctx.open }]),
      title: _ctx.intf.name,
      onClick: _cache[0] || (_cache[0] = ($event) => _ctx.open = !_ctx.open)
    }, [
      vue.createElementVNode("div", _hoisted_2$1, [
        vue.createElementVNode("div", _hoisted_3$1, vue.toDisplayString(_ctx.selectedText), 1),
      ...
      vue.createVNode(vue.Transition, { name: "slide-fade" }, {
        default: vue.withCtx(() => [
          vue.withDirectives(vue.createElementVNode("div", _hoisted_5, [
            vue.createElementVNode("div", _hoisted_6, vue.toDisplayString(_ctx.intf.name), 1),
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.intf.items, (item, i) => {
              return vue.openBlock(), vue.createElementBlock("div", {
                key: i,
                class: vue.normalizeClass(["item", { "--active": item === _ctx.selectedItem }]),
                onClick: ($event) => _ctx.setSelected(item)
              }, vue.toDisplayString(typeof item === "string" ? item : item.text), 11, _hoisted_7);
            }), 128))
          ], 512), [
            [vue.vShow, _ctx.open]
          ])
  ...
  class SelectInterface extends core.NodeInterface {
    constructor(name, value, items) {
      super(name, value);
      this.component = vue.markRaw(SelectInterfaceComponent);
      this.items = items;
    }
  }
  const _sfc_main$d = vue.defineComponent({
    ...
    setup(props) {
      const el = vue.ref(null);
      const baseNumericInterface = useBaseNumericInterface(vue.toRef(props, "intf"));
      const didSlide = vue.ref(false);
  ...
  function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", {
      ref: "el",
      class: vue.normalizeClass(["baklava-slider", { "baklava-ignore-mouse": !_ctx.editMode }]),
      ...
      vue.createElementVNode("div", {
        class: "__slider",
        style: vue.normalizeStyle({ width: _ctx.percentage + "%" })
      }, null, 4),
      !_ctx.editMode ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$c, [
        vue.createElementVNode("div", _hoisted_2, vue.toDisplayString(_ctx.intf.name), 1),
        vue.createElementVNode("div", _hoisted_3, vue.toDisplayString(_ctx.stringRepresentation), 1)
        ...
        vue.withDirectives(vue.createElementVNode("input", {
          ...
          onKeydown: _cache[2] || (_cache[2] = vue.withKeys((...args) => _ctx.leaveEditMode && _ctx.leaveEditMode(...args), ["enter"]))
        }, null, 34), [
          [vue.vModelText, _ctx.tempValue]
        ])
      ]))
  ...
  class SliderInterface extends BaseNumericInterface {
    constructor(name, value, min, max) {
      ...
      this.component = vue.markRaw(SliderInterfaceComponent);
      this.min = min;
      this.max = max;
    }
  }
  ...
  function _sfc_render$c(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", null, vue.toDisplayString(_ctx.intf.value), 1);
  }
  const TextInterfaceComponent = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$c]]);
  class TextInterface extends core.NodeInterface {
    constructor(name, value) {
      super(name, value);
      this.component = vue.markRaw(TextInterfaceComponent);
      this.setPort(false);
    }
  }
  ...
  function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("div", null, [
      vue.withDirectives(vue.createElementVNode("input", {
        ...
        [vue.vModelText, _ctx.v]
      ])
    ]);
  }
  const TextInputInterfaceComponent = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b]]);
  class TextInputInterface extends core.NodeInterface {
    constructor() {
      super(...arguments);
      this.component = vue.markRaw(TextInputInterfaceComponent);
    }
  }
  ...
  const _hoisted_1$a = ["placeholder", "title"];
  ...
  const TextareaInputInterfaceComponent = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a]]);
  class TextareaInputInterface extends core.NodeInterface {
    constructor() {
      super(...arguments);
      this.component = vue.markRaw(TextareaInputInterfaceComponent);
    }
  }
  const byteToHex = [];
  for (let i = 0; i < 256; ++i) {
  ...
  class SubgraphInputNode extends core.GraphInputNode {
    constructor() {
      super(...arguments);
      ...
      this.outputs = {
        placeholder: new core.NodeInterface("Connection", void 0)
      };
    }
  }
  class SubgraphOutputNode extends core.GraphOutputNode {
    constructor() {
      super(...arguments);
      ...
      this.outputs = {
        output: new core.NodeInterface("Output", void 0).setHidden(true)
      };
    }
  }
  const CREATE_SUBGRAPH_COMMAND = "CREATE_SUBGRAPH";
  const IGNORE_NODE_TYPES = [core.GRAPH_INPUT_NODE_TYPE, core.GRAPH_OUTPUT_NODE_TYPE];
  function registerCreateSubgraphCommand(displayedGraph, handler, switchGraph) {
    ...
    const createSubgraph = () => {
      ...
      const subgraphTemplate = vue.reactive(
        new core.GraphTemplate(
          {
  ...
  function useHistory(graph, commandHandler) {
    ...
    const maxSteps = vue.ref(200);
    const steps = vue.ref([]);
    const changeBySelf = vue.ref(false);
    const currentIndex = vue.ref(-1);
    const activeTransaction = vue.ref(false);
    const transactionSteps = vue.ref([]);
    const addStep = (step) => {
  ...
  function useClipboard(displayedGraph, editor, commandHandler) {
    ...
    const nodeBuffer = vue.ref("");
    const connectionBuffer = vue.ref("");
    const isEmpty = vue.computed(() => !nodeBuffer.value);
    const clear = () => {
      nodeBuffer.value = "";
  ...
  const displayInSidebar = (intf, displayInSidebar2) => {
  ...
  const ZOOM_TO_FIT_RECT_COMMAND = "ZOOM_TO_FIT_RECT";
  const ZOOM_TO_FIT_NODES_COMMAND = "ZOOM_TO_FIT_NODES";
  const ZOOM_TO_FIT_GRAPH_COMMAND = "ZOOM_TO_FIT_GRAPH";
  ...
  function _sfc_render$9(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$9, _cache[0] || (_cache[0] = [
      ...
      vue.createElementVNode("path", { d: "M9 13l-4 -4l4 -4m-4 4h11a4 4 0 0 1 0 8h-1" }, null, -1)
    ]));
  }
  ...
  function _sfc_render$8(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$8, _cache[0] || (_cache[0] = [
      ...
      vue.createElementVNode("path", { d: "M15 13l4 -4l-4 -4m4 4h-11a4 4 0 0 0 0 8h1" }, null, -1)
    ]));
  }
  ...
  function _sfc_render$6(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$6, _cache[0] || (_cache[0] = [
      ...
      vue.createElementVNode("path", { d: "M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" }, null, -1),
  ...
  function _sfc_render$5(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$5, _cache[0] || (_cache[0] = [
      ...
      vue.createElementVNode("path", { d: "M16 8v-2a2 2 0 0 0 -2 -2h-8a2 2 0 0 0 -2 2v8a2 2 0 0 0 2 2h2" }, null, -1)
    ]));
  }
  ...
  function _sfc_render$4(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$4, _cache[0] || (_cache[0] = [
      ...
      vue.createElementVNode("path", { d: "M6 4h10l4 4v10a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2" }, null, -1),
      vue.createElementVNode("circle", {
        cx: "12",
        cy: "14",
        r: "2"
      }, null, -1),
      vue.createElementVNode("polyline", { points: "14 4 14 8 8 8 8 4" }, null, -1)
    ]));
  }
  ...
  function _sfc_render$3(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$3, _cache[0] || (_cache[0] = [
      vue.createStaticVNode('<path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 3h4v4h-4z"></path><path d="M3 17h4v4h-4z"></path><path d="M17 17h4v4h-4z"></path><path d="M7 17l5 -4l5 4"></path><line x1="12" y1="7" x2="12" y2="13"></line>', 6)
    ]));
  }
  ...
  function _sfc_render$2(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$2, _cache[0] || (_cache[0] = [
      vue.createStaticVNode('<path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M8 8m0 1a1 1 0 0 1 1 -1h6a1 1 0 0 1 1 1v6a1 1 0 0 1 -1 1h-6a1 1 0 0 1 -1 -1z"></path><path d="M12 20v.01"></path><path d="M16 20v.01"></path><path d="M8 20v.01"></path><path d="M4 20v.01"></path><path d="M4 16v.01"></path><path d="M4 12v.01"></path><path d="M4 8v.01"></path><path d="M4 4v.01"></path><path d="M8 4v.01"></path><path d="M12 4v.01"></path><path d="M16 4v.01"></path><path d="M20 4v.01"></path><path d="M20 8v.01"></path><path d="M20 12v.01"></path><path d="M20 16v.01"></path><path d="M20 20v.01"></path>', 18)
    ]));
  }
  const SelectAll = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
  const _sfc_main$1 = {};
  const _hoisted_1$1 = {
    xmlns: "http://www.w3.org/2000/svg",
    class: "baklava-icon",
  ...
  function _sfc_render$1(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$1, _cache[0] || (_cache[0] = [
      vue.createStaticVNode('<path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 7l16 0"></path><path d="M10 11l0 6"></path><path d="M14 11l0 6"></path><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12"></path><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3"></path>', 6)
    ]));
  }
  const Trash = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
  const _sfc_main = {};
  const _hoisted_1 = {
    xmlns: "http://www.w3.org/2000/svg",
    class: "baklava-icon",
  ...
  function _sfc_render(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
      vue.createStaticVNode('<path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 8v-2a2 2 0 0 1 2 -2h2"></path><path d="M4 16v2a2 2 0 0 0 2 2h2"></path><path d="M16 4h2a2 2 0 0 1 2 2v2"></path><path d="M16 20h2a2 2 0 0 0 2 -2v-2"></path><path d="M8 11a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"></path><path d="M16 16l-2.5 -2.5"></path>', 7)
    ]));
  }
  const ZoomScan = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
  ...
  const DEFAULT_TOOLBAR_COMMANDS = Object.values(TOOLBAR_COMMANDS);
  const TOOLBAR_SUBGRAPH_COMMANDS = {
  ...
  const DEFAULT_TOOLBAR_SUBGRAPH_COMMANDS = Object.values(TOOLBAR_SUBGRAPH_COMMANDS);
  const isTemplate = (g) => !(g instanceof core.Graph);
  function useSwitchGraph(editor, displayedGraph) {
    const switchGraph = (newGraph) => {
      ...
      if (!isTemplate(newGraph)) {
        ...
        newGraphInstance = new core.Graph(editor.value);
  ...
  function useBaklava(existingEditor) {
    const editor = vue.ref(existingEditor ?? new core.Editor());
    const token = Symbol("ViewModelToken");
    const _displayedGraph = vue.ref(null);
    const displayedGraph = vue.shallowReadonly(_displayedGraph);
    const { switchGraph } = useSwitchGraph(editor, _displayedGraph);
    const isSubgraph = vue.computed(() => displayedGraph.value && displayedGraph.value !== editor.value.graph);
    ...
    const hooks = {
      ...
      renderNode: new events.SequentialHook(null),
      /** Called whenever an interface is rendered */
      renderInterface: new events.SequentialHook(null)
    };
  ...
  exports2.BaklavaEditor = _sfc_main$k;
  exports2.ButtonInterface = ButtonInterface;
  exports2.ButtonInterfaceComponent = ButtonInterfaceComponent;
  exports2.CheckboxInterface = CheckboxInterface;
  exports2.CheckboxInterfaceComponent = _sfc_main$i;
  exports2.Commands = commandList;
  exports2.Components = components;
  exports2.DEFAULT_TOOLBAR_COMMANDS = DEFAULT_TOOLBAR_COMMANDS;
  exports2.DEFAULT_TOOLBAR_SUBGRAPH_COMMANDS = DEFAULT_TOOLBAR_SUBGRAPH_COMMANDS;
  exports2.EditorComponent = _sfc_main$k;
  exports2.IntegerInterface = IntegerInterface;
  exports2.IntegerInterfaceComponent = IntegerInterfaceComponent;
  exports2.NumberInterface = NumberInterface;
  exports2.NumberInterfaceComponent = _sfc_main$f;
  exports2.SelectInterface = SelectInterface;
  exports2.SelectInterfaceComponent = SelectInterfaceComponent;
  exports2.SliderInterface = SliderInterface;
  exports2.SliderInterfaceComponent = SliderInterfaceComponent;
  exports2.TOOLBAR_COMMANDS = TOOLBAR_COMMANDS;
  exports2.TOOLBAR_SUBGRAPH_COMMANDS = TOOLBAR_SUBGRAPH_COMMANDS;
  exports2.TemporaryConnectionState = TemporaryConnectionState;
  exports2.TextInputInterface = TextInputInterface;
  exports2.TextInputInterfaceComponent = TextInputInterfaceComponent;
  exports2.TextInterface = TextInterface;
  exports2.TextareaInputInterface = TextareaInputInterface;
  exports2.TextareaInputInterfaceComponent = TextareaInputInterfaceComponent;
  exports2.displayInSidebar = displayInSidebar;
  exports2.getDomElementOfNode = getDomElementOfNode;
  exports2.getDomElements = getDomElements;
  exports2.getNodePosition = getNodePosition;
  exports2.getPortCoordinates = getPortCoordinates;
  exports2.isInputElement = isInputElement;
  exports2.providePlugin = providePlugin;
  exports2.provideTemporaryConnection = provideTemporaryConnection;
  exports2.setNodePosition = setNodePosition;
  exports2.useBaklava = useBaklava;
  exports2.useCommandHandler = useCommandHandler;
  exports2.useDragMove = useDragMove;
  exports2.useGraph = useGraph;
  exports2.useNodeCategories = useNodeCategories;
  exports2.useTemporaryConnection = useTemporaryConnection;
  exports2.useTransform = useTransform;
  exports2.useViewModel = useViewModel;
