...
exports.DependencyEngine = exports.allowMultipleConnections = void 0;
const baseEngine_1 = require("./baseEngine");
const topologicalSorting_1 = require("./topologicalSorting");
const allowMultipleConnections = (intf) => {
    intf.allowMultipleConnections = true;
};
exports.allowMultipleConnections = allowMultipleConnections;
class DependencyEngine extends baseEngine_1.BaseEngine {
    constructor(editor) {
        super(editor);
        this.order = new Map();
    }
    ...
    async runGraph(graph, inputs, calculationData) {
        if (!this.order.has(graph.id)) {
            this.order.set(graph.id, (0, topologicalSorting_1.sortTopologically)(graph));
        }
