import { AbstractNode, NodeInterface, IConnection, Editor, INodeUpdateEventData, Graph, CheckConnectionHookResult, CalculationResult, IEngine } from "@baklavajs/core";
...
export declare abstract class BaseEngine<CalculationData, CalculationArgs extends Array<any>> implements IEngine<CalculationData> {
    ...
    events: {
         ...
         */
        beforeRun: PreventableBaklavaEvent<CalculationData, BaseEngine<CalculationData, CalculationArgs>>;
        /**
         * This event is called as soon as a run is completed.
         * The argument is the result of the calculation.
         */
        afterRun: BaklavaEvent<CalculationResult, BaseEngine<CalculationData, CalculationArgs>>;
        statusChange: BaklavaEvent<EngineStatus, BaseEngine<CalculationData, CalculationArgs>>;
        /**
         * This event is called before a node is calculated.
         * It is not preventable since this would break calculation.
         */
        beforeNodeCalculation: BaklavaEvent<BeforeNodeCalculationEventData, BaseEngine<CalculationData, CalculationArgs>>;
        /** This event is called after a node has been calculated. */
        afterNodeCalculation: BaklavaEvent<AfterNodeCalculationEventData, BaseEngine<CalculationData, CalculationArgs>>;
    };
    hooks: {
        gatherCalculationData: SequentialHook<CalculationData | undefined, BaseEngine<CalculationData, CalculationArgs>, CalculationData>;
        transferData: DynamicSequentialHook<any, IConnection, any>;
    };
    get status(): EngineStatus;
    protected recalculateOrder: boolean;
     ...
     */
    runOnce(calculationData: CalculationData, ...args: CalculationArgs): Promise<CalculationResult | null>;
    /**
     ...
     */
    abstract runGraph(graph: Graph, inputs: Map<string, any>, calculationData: CalculationData): Promise<CalculationResult>;
    /**
     * Gathers the values of all unconnected input interfaces in the graph
     * @returns Map nodeInterface.id -> value
     */
    abstract getInputValues(graph: Graph): Map<string, any>;
     ...
     */
    checkConnection(from: NodeInterface, to: NodeInterface): CheckConnectionHookResult;
    /**
     ...
     */
    protected calculateWithoutData(...args: CalculationArgs): Promise<CalculationResult | null>;
    /**
     ...
     * @returns The calculation result
     */
    protected abstract execute(calculationData: CalculationData, ...calculationArgs: CalculationArgs): Promise<CalculationResult>;
    /**
     ...
     */
    protected abstract onChange(recalculateOrder: boolean, updatedNode?: AbstractNode, data?: INodeUpdateEventData): void;
