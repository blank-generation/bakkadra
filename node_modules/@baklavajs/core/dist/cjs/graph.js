...
class Graph {
    ...
    constructor(editor, template) {
        ...
        this.events = {
            beforeAddNode: new events_1.PreventableBaklavaEvent(this),
            addNode: new events_1.BaklavaEvent(this),
            beforeRemoveNode: new events_1.PreventableBaklavaEvent(this),
            removeNode: new events_1.BaklavaEvent(this),
            beforeAddConnection: new events_1.PreventableBaklavaEvent(this),
            addConnection: new events_1.BaklavaEvent(this),
            checkConnection: new events_1.PreventableBaklavaEvent(this),
            beforeRemoveConnection: new events_1.PreventableBaklavaEvent(this),
            removeConnection: new events_1.BaklavaEvent(this),
        };
        this.hooks = {
            save: new events_1.SequentialHook(this),
            load: new events_1.SequentialHook(this),
            checkConnection: new events_1.ParallelHook(this),
        };
        this.nodeEvents = (0, events_1.createProxy)();
        this.nodeHooks = (0, events_1.createProxy)();
    ...
    addConnection(from, to) {
        ...
        const c = new connection_1.Connection(checkConnectionResult.dummyConnection.from, checkConnectionResult.dummyConnection.to);
    ...
    checkConnection(from, to) {
        ...
        return {
            ...
            dummyConnection: new connection_1.DummyConnection(from, to),
            connectionsInDanger,
        };
    }
    /**
        ...
        try {
            ...
            for (const c of state.connections) {
                ...
                if (!fromIf) {
                    ...
                    const conn = new connection_1.Connection(fromIf, toIf);
                    conn.id = c.id;
